...
import { getAztecPublicKey } from './utils'
...
export class AddressBook extends Component {
  ...
  constructor(props) {
    ...
    const savedContacts = savedContactString ? fromJS( JSON.parse(savedContactString) ) :
      List([
      /*
        Map({
          address   : parsed.TEST_ADDRESS_4,
          publicKey : parsed.TEST_PUBLIC_KEY_4,
        }),
       */
        Map({
